...
def vgg(cfg, pretrained=True):
    ...
    if pretrained:
        ...
        vgg_weight = torch.load("F:\\ObjectDetection\\deeplearning\\ObjectDetection_SSD_VOC2012-main\\vgg16_reducedfc.pth",
                            map_location="cpu")
        model.init_from_pretrain(vgg_weight)
        # model.load_state_dict(vgg_weight)
